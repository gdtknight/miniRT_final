# README - miniRT 문서 가이드

## 📚 문서 목록

### 1. [프로그램 개요](./01_프로그램_개요.md)
- miniRT 프로젝트 소개
- 지원 기능 및 객체
- 프로젝트 구조
- 실행 방법
...
2. **[벡터 수학](./06_벡터_수학.md)** → 기초 수학 개념
3. **[씬 파일 파싱](./05_씬_파일_파싱.md)** → 입력 데이터 이해
4. **[레이 트레이싱 알고리즘](./03_레이_트레이싱_알고리즘.md)** → 핵심 로직
5. **[조명 및 그림자 시스템](./04_조명_그림자_시스템.md)** → 시각적 품질
6. **[프로그램 흐름](./02_프로그램_흐름.md)** → 전체 통합
