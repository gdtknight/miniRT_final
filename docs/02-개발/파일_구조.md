...
| 파일 유형 | 위치 | 예외 |
|----------|------|------|
| 프로젝트 문서 | `docs/` (numbered categories) | `README.md` (루트) |
| 릴리스 노트 | `docs/04-릴리스/릴리스_노트.md` | - |
| 구현 요약 | `docs/05-프로젝트_히스토리/구현_요약/` | Issue-numbered |
| 배포 요약 | `docs/05-프로젝트_히스토리/배포_요약.md` | - |
| 검증 보고서 | `docs/04-릴리스/검증_보고서.md` | - |
| 프로젝트 히스토리 | `docs/05-프로젝트_히스토리/` | - |

**규칙**:
- 모든 `.md` 파일은 `docs/` 디렉토리의 번호순 카테고리에 위치
- `README.md`만 프로젝트 루트에 배치
- 문서는 한글 작성 (Constitution v1.2.1)
- 파일명은 한글과 언더스코어 사용: `파일_이름.md`
